...
&nbsp 1. save it<br>
&nbsp 2. copy it to the resources folder of the game<br>
&nbsp 3. rename it to l[level number].dat (replace "[level number]" with the level number you want it to be)<br>
&nbsp 4. edit the levels_hash array in the main.cpp and recompile
