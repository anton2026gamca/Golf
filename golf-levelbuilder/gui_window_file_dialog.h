...
//----------------------------------------------------------------------------------
GuiWindowFileDialogState InitGuiWindowFileDialog(const char *initPath, int windowWidth, int windowHeight, const char *windowTitle);
...
GuiWindowFileDialogState InitGuiWindowFileDialog(const char *initPath, int windowWidth, int windowHeight, const char *windowTitle)
{
    ...
    // Init window data
    state.windowBounds = (Rectangle){ GetScreenWidth()/2.0f - windowWidth/2.0f, GetScreenHeight()/2.0f - windowHeight/2.0f, windowWidth, windowHeight };
    state.windowActive = false;
    state.supportDrag = true;
    state.dragMode = false;
    state.panOffset = (Vector2){ 0, 0 };
    state.title = (char*)windowTitle;
...
void GuiWindowFileDialog(GuiWindowFileDialogState *state)
{
    if (state->windowActive)
    {
        ...
        //----------------------------------------------------------------------------------------
        state->windowActive = !GuiWindowBox(state->windowBounds, GuiIconText(ICON_WINDOW, state->title));
